"""
Django settings for quiet_wood_dev_87624 project.
...
ROOT_URLCONF = 'quiet_wood_dev_87624.urls'
...
WSGI_APPLICATION = 'quiet_wood_dev_87624.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_wood_dev_87624 API",
    "DESCRIPTION": "API documentation for quiet_wood_dev_87624 App",
    "VERSION": "v1",
}
